...
public class ElementsBeanFactoryImpl implements ElementsBeanFactory {

    public ElementsBean createElementsBean(Module... modules) {
        return createElementsBean(Elements.getElements(modules), new ElementsBeanVisitorImpl());
    }

    protected ElementsBean createElementsBean(Collection<Element> elements, ElementsBeanVisitor beanVisitor) {
        for (Element e : elements) {
            e.acceptVisitor(beanVisitor);
        }
        
        return beanVisitor.asElementsBean();
    }
    
    protected static interface ElementsBeanVisitor extends ElementVisitor<Void> {
        public ElementsBean asElementsBean();
    }

    private static class ElementsBeanVisitorImpl extends DefaultElementVisitor<Void> implements ElementsBeanVisitor {
